...
@Component
public class DemoTaskletLog4 implements Tasklet {

	/* Spring Bootでログ出力するためのLogbackのクラスを生成 */
	private static final Logger LOGGER = LoggerFactory.getLogger(DemoTaskletLog4.class);
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		if (paramStr != null) {
			...
			LOGGER.info("DemoTaskletLog4 execute " + " triggered: " + param.getTimerInfo());
		}
